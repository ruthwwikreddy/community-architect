        ...
        <div className="space-y-1">
          {experiences.map((exp, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`group py-12 border-t ${index === experiences.length - 1 ? 'border-b' : ''} border-zinc-900 grid lg:grid-cols-4 gap-8 hover:bg-zinc-900/50 transition-all px-4 rounded-xl`}
            >
